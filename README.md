...
A static website for Quigg Property (Cork estate agents), built with plain HTML/CSS/JS — no build step required.
...
- `assets/logo-mark-plate.jpg`, `assets/brand-plate.jpg` — Polished embossed gold-on-navy lockup supplied later; used for the header/footer mark and as a featured brand image on the About page and homepage CTA band
...
- Tagline: "Trusted Locally · Connected Globally"
